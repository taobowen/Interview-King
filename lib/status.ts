...
export const STATUSES: Status[] = ['Saved','Applied','OA','Screen','Tech','Onsite','Offer','Accepted','Rejected','Closed'];
export const STATUS_ORDER: Record<Status, number> = {
Saved:0, Applied:1, OA:2, Screen:3, Tech:4, Onsite:5, Offer:6, Accepted:7, Rejected:99, Closed:100
};
...
export const STAGES: Status[] = [
  'Applied','OA','Screen','Tech','Onsite','Offer','Accepted','Rejected','Closed'  
];

export const STATUS_HEX = {
  Saved:'#cbd5e1', Applied:'#60a5fa', OA:'#818cf8', Screen:'#f59e0b',
  Tech:'#a78bfa', Onsite:'#14b8a6', Offer:'#22c55e', Accepted:'#10b981', Rejected:'#f43f5e', Closed:'#6b7280',
} as const;
